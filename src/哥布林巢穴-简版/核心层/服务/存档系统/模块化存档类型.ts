  ...
  breedingSlots: [
    {
      building: {
        ...
        name: '繁殖间',
        icon: '👶',
        description: '用于俘虏生育黑液寄生虫',
        cost: { gold: 50, food: 30 },
        category: 'breeding',
        effects: [{ type: 'breeding', icon: '👶', description: '俘虏生育黑液寄生虫' }],
      },
      unlocked: true,
    },
    {
...
const BASE_TRAINING_CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    lifeStory: {
      ...
      adolescence: [
        '十三岁时，老祭司去世了，雫成为了神殿中唯一的神官。她独自维持着神殿的运作，为路过的旅人提供治疗和祝福。两年后，一群黑液寄生虫袭击了附近的村庄，雫和几个新人冒险者组队前去讨伐。那是她第一次离开神殿，也是她第一次真正面对黑液寄生虫的残暴。她的队友几乎全军覆没，她自己也被黑液寄生虫的毒箭射中左肩。就在她以为自己必死无疑时，当年她救过的那个冒险者出现了——一个总是戴着头盔、专门讨伐黑液寄生虫的战士。他救了她，并告诉她，对付黑液寄生虫不能心慈手软。从那以后，雫开始跟随那位战士讨伐黑液寄生虫，她学会了在法袍下穿锁子甲，学会了使用投石索支援，也学会了在危险中生存。',
      ],
      adulthood: [
        '如今十九岁的雫已经是一名经验丰富的冒险者。她跟随那位战士讨伐了无数黑液虫巢穴，见证了太多女性被黑液寄生虫蹂躏的悲惨景象。这些经历让她变得更加坚定，也更加明白黑液寄生虫的威胁有多么可怕。但在某次讨伐行动中，她与那位战士走散了。她被一群黑液寄生虫包围，尽管她拼命战斗，但最终还是被俘虏了。现在她被带到了古拉尔大陆的一个黑液虫巢穴中，成为了囚犯。她知道黑液寄生虫会对她做什么，她见过太多这样的受害者。她只能在心中默默祈祷，希望那位战士能够找到她，希望女神能够保佑她。',
      ],
      currentState: [
    ...
    fears:
      '雫最大的恐惧是失去对女神的信仰，或者被迫背叛自己的信念。她见过太多被黑液寄生虫俘虏的女性，她们的眼神空洞，灵魂已经死去。她害怕自己也会变成那样。她也害怕那位一直保护她的战士永远找不到她，害怕自己会在这个巢穴中度过余生，成为黑液寄生虫的生育机器。',
    secrets:
      '雫最大的秘密是她对那位救过她的战士的感情。虽然她从未向任何人透露过，但她内心深处对那个冷酷但温柔的男人有着超越战友关系的情感。她希望能够一直和他在一起，希望能够成为他真正的伙伴。但她知道，那位战士对黑液寄生虫的仇恨深入骨髓，他不会为了任何人停下脚步。她也知道，自己可能永远无法向他表达这份感情。现在她被俘虏了，这个秘密可能会成为她心中永远的遗憾。她只希望，如果她真的无法逃脱，至少能够在生命的最后时刻，再见他一面。',
    appearance: {
      height: 155,
      weight: 42,
      ...
      cupSize: 'B',
      description:
        '雫的身材娇小纤细，如同尚未完全绽放的花蕾。她拥有一头如阳光般灿烂的金色长发，发丝柔顺而富有光泽，通常垂至腰间，几缕碎发自然地垂落在脸颊两侧，为她增添了一丝少女的柔美。她的肌肤白皙如雪，细腻娇嫩，仿佛从未经历过风霜雨露的摧残，在光线下泛着淡淡的珍珠般的光泽。她的五官精致可爱，眉毛纤细而自然，高挺的鼻梁下是一张樱桃小嘴，总是抿着，透露着少女的青涩和不安。她最引人注目的是那双如天空般清澈的蓝色眼眸，眼神中既有少女的纯真也有神官的虔诚，睫毛纤长而卷翘，在脸上投下淡淡的阴影。她的颈项修长优雅，锁骨精致而突出，乳房刚刚发育，娇小而挺拔。她的腰肢纤细，盈盈不足一握。臀部小巧圆润，曲线柔和，有着修长纤细的双腿。她的手指纤细修长，从未做过重活，保养得极好，指甲修剪整齐，呈现健康的粉色。她的左肩膀上有一道淡淡的伤疤，那是被黑液寄生虫毒箭射中留下的印记，这是她成长历程的见证。',
      clothing: {
        head: '神官帽子',
        top: '白色的神官袍',
        bottom: '白色的神官长裙',
...
const BASE_LOCATIONS: Location[] = [
  ...
  },
  {
    ...
    icon: '🏕️',
    description:
      '一支来自远方的贸易商队在此临时驻扎。商队由经验丰富的商人组成，携带着各种珍贵的货物和商品。营地周围有坚固的马车围栏，商队护卫们日夜巡逻。这里不仅有丰富的物资，还可能遇到来自其他大陆的稀有商品。商队头领是一位精明的商人，对黑液寄生虫的威胁有所耳闻。',
    difficulty: 1,
    distance: 8,
  ...
  },
  {
    ...
    icon: '🏚️',
    description:
      '位于古拉尔大陆边缘的流放者聚居地，由被各国驱逐的罪犯、政治犯和异端分子组成。村落建在贫瘠的山丘上，房屋简陋但防御严密。这里的居民虽然被主流社会抛弃，但形成了自己的生存法则和战斗技巧。他们对外来者极度警惕，对黑液寄生虫的威胁有着丰富的应对经验。村落中心有一座简陋的审判堂，是流放者们制定规则的地方。',
    difficulty: 2,
    distance: 15,
